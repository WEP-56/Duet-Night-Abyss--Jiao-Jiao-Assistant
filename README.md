...
2025.11.28 27号官方大面积封禁每日在线时长较长的脚本用户，同时经群聊统计，win32脚本被封禁比例较大，因此本项目的更新将停止上传，等封号风波过去了再上传新的版本吧，还有经解包，脚本检测仅在手机端，pc端键鼠这两个使用情况在onmouse后检测，建议使用云游戏脚本或手柄宏，b站应该搜得到。

...
偶遇超级技术难题拼尽全力无法解决，无尽模式伦次结束后的“撤离”与“再次挑战”按键无法通过sendmessge或postmessge点击，此二个按键可能是隐藏的子弹窗或子控键。如有解决方案可以发送至1484413790@qq.com，万分感谢
...
增加自定义快捷键功能.支持组合键操作（如螺旋飞跃二段跳冲刺快速跑图）.
